...
const TextEditor = ({ note, onClose, setIsEditing, bgColor, standalone }) => {
  ...
  const [selectedNotebook, setSelectedNotebook] = useState(
    note?.notebookId ? note.notebookId : notebookList[0]?.id
  );
  ...
  useEffect(() => {}, [name, selectedNotebook, dispatch, htmlContent]);
    ...
    <div className="editor-page-wrapper" style={editorStyles?.editorContainer}>
      ...
      <div className="text-editor-container">
        <div
          ...
          <div className="text-editor-toolbar">
            ...
            <div
              ...
              style={{ backgroundColor: bgColor }}>
              <input
                className="editor-color-button editor-button"
                type="color"
        ...
        <div className="editor-footer">
          <button
            className="save-note-button editor-button"
